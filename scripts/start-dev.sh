...
# 创建数据库
echo "创建数据库..."
mysql -u root -e "CREATE DATABASE IF NOT EXISTS filemanager DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

# 创建用户并授权
mysql -u root -e "CREATE USER IF NOT EXISTS 'appuser'@'localhost' IDENTIFIED BY 'apppassword';"
mysql -u root -e "GRANT ALL PRIVILEGES ON filemanager.* TO 'appuser'@'localhost';"
