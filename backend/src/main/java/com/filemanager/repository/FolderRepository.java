...
public interface FolderRepository extends JpaRepository<Folder, Long> {
    ...
    Page<Folder> findByUser_IdAndParent_IdAndDeletedFalse(Long userId, Long parentId, Pageable pageable);

    long countByUser_IdAndParent_IdAndDeletedFalse(Long userId, Long parentId);
